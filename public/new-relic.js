(function () {
  ...
  const URLS = {
    "settings.mbopartners.com": ENV.PROD,
    "settings-preprod.mbopartners.com": ENV.PREPROD,
  };

  if (URLS[window.location.host] === ENV.PROD) {
    window.NREUM || (NREUM = {});
              ...
              try {
                (i = localStorage.getItem("__nr_flags").split(",")),
                  console &&
                    ...
                    ((s.console = !0),
                    i.indexOf("dev") !== -1 && (s.dev = !0),
                    i.indexOf("nr_dev") !== -1 && (s.nrDev = !0));
              } catch (c) {}
              s.nrDev &&
          ...
          15: [
            function (t, e, n) {
              ...
              function i(t, e, n) {
                return function () {
                  return (
                    o(t, [f.now()].concat(s(arguments)), e ? null : this, n),
                    e ? void 0 : this
                  );
                };
              }
              ...
              function i(t) {
                ...
                function n(n, r, i, o, a) {
                  if ((a !== !1 && (a = !0), !p.aborted || o)) {
                    t && a && t(n, r, i);
                    for (
                      var s = e(i), c = m(n), f = c.length, u = 0;
                      u < f;
                      u++
                    )
                      c[u].apply(s, r);
            ...
            function (t, e, n) {
              ...
              var b = "" + location,
                E = {
                  ...
                  agent: "js-agent.newrelic.com/nr-1209.min.js",
                },
                R = g && y && y[w] && !/CriOS/.test(navigator.userAgent),
                O = (e.exports = {
              ...
              if (!x) {
                t(15),
                  t(21),
                  m[w]
                    ? (m[w]("DOMContentLoaded", o, !1), h[w]("load", r, !1))
                    : (m[v]("onreadystatechange", i), h[v]("onload", r)),
    ...
    NREUM.loader_config = {
      ...
      trustKey: "3000311",
      agentID: "1386057764",
      licenseKey: "NRJS-26914a0ca124c858e64",
      applicationID: "1386057764",
    };
    NREUM.info = {
